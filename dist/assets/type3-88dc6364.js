...
let ue, Le = Promise.all([ (() => {
    ...
    let d, _, w, M, T, A, V, H, R, q, C, L, x, B, I, z, F, P, U, j, Q, $, D, E, G, K, O, J, N, W, X, Y, Z, ee, ae;
    d = m => (Ve("data-v-f66d5aeb"), m = m(), He(), m), _ = {
        class: "qusetion-info"
    }, w = {
        class: "info-item"
    }, M = {
        ...
        setup(m, {
            ...
            return (n, i) => {
                const c = _e, te = we, ke = Me, ye = Te, Se = Ae;
                return t(), r("div", _, [ g(l("div", w, [ g(l("div", M, "题干", 512), [ [ b, !a(k) ] ]), l("div", {
                    class: "value",
                    innerHTML: a(e).stem
                }, null, 8, T) ], 512), [ [ b, !a(pe) ] ]), l("div", A, [ g(l("div", V, "选项", 512), [ [ b, !a(k) ] ]), l("div", H, [ (t(!0), 
                r(de, null, ce(a(e).choices || [], (s, S) => {
                    return t(), r("div", {
                        ...
                        value: s.choiceId,
                        "model-value": !a(se) || [ "4" ].includes(a(p)) ? a(e).candidateAnswer : ""
                    }, {
                        default: h(() => [ f(o(ie(S) + "."), 1) ]),
                        _: 2
                    ...
                    var re;
                }), 128)) ]) ]), [ "0", "1", "2" ].includes(a(p)) ? (t(), r("div", C, [ l("div", L, [ u(ke, {
                    ...
                    _: 1
                }, 8, [ "modelValue" ]), l("span", x, [ f(" 得分 "), u(ye, {
                    ...
                    class: "markStyle",
                    size: "large"
                }, null, 8, [ "modelValue", "max" ]), f(" 分 ") ]) ]) ])) : v("", !0), a(se) ? v("", !0) : (t(), 
                r("div", {
                    key: 1,
                    class: ne(a(k) ? "py-2 pr-5 qusetion-bg-gray" : "")
                }, [ l("div", B, [ I, l("div", z, o(a(he)), 1) ]), l("div", F, [ P, l("div", {
                    class: "value",
                    innerHTML: a(e).analysis ?? "--"
                }, null, 8, U) ]), [ "2", "3", "4" ].includes(a(p)) ? (t(), r("div", j, [ Q, l("div", $, o(a(e).remark ?? "--"), 1) ])) : v("", !0), a(e).markerRemarks.length > 0 ? (t(), 
                r("div", D, [ E, l("div", G, o((y = a(e).markerRemarks, y.length > 0 ? y.map(s => `${s.marker ?? "--"}\uFF0C\u4E8E${oe(s.markerTime) ?? "--"}\u6279\u9605`).join("；") : "--")), 1) ])) : v("", !0) ], 2)), [ "3", "2", "4" ].includes(a(p)) && a(e).changeMarkers.length > 0 ? (t(), 
                r("div", K, [ (t(!0), r(de, null, ce(a(e).changeMarkers, (s, S) => (t(), 
                r("div", {
                    key: S
                }, [ l("div", O, [ J, l("div", N, o(s.changeMarker ?? "--") + "，于" + o(a(oe)(s.changeMarkerTime) ?? "--") + "改阅", 1) ]), l("div", W, [ X, l("div", Y, o(s.changeRevision ?? "--"), 1) ]) ]))), 128)) ])) : v("", !0), [ "0", "1" ].includes(a(p)) ? (t(), 
