...
let b, x, $, D, E, B, R = Promise.all([ (() => {
    ...
    var g, A, C = Object.defineProperty, v = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, h = Object.prototype.hasOwnProperty, m = (t, n, _, e) => {
        if (n && typeof n == "object" || typeof n == "function") for (let o of w(n)) h.call(t, o) || o === _ || C(t, o, {
            get: () => n[o],
            enumerable: !(e = v(n, o)) || e.enumerable
        });
        return t;
    }, r = {};
    m(r, g = P, "default"), A && m(A, g, "default");
    var u = [ "assign", "flush", "ftl", "return", "global", "import", "include", "break", "continue", "local", "nested", "nt", "setting", "stop", "t", "lt", "rt", "fallback" ], c = [ "attempt", "autoesc", "autoEsc", "compress", "comment", "escape", "noescape", "function", "if", "list", "items", "sep", "macro", "noparse", "noParse", "noautoesc", "noAutoEsc", "outputformat", "switch", "visit", "recurse" ], a = {
        close: ">",
        id: "angle",
        open: "<"
    }, s = {
...
\r	 }]),.:;=`,
            ...
            folding: {
                markers: {
                    start: new RegExp(`${t.open}#(?:${c.join("|")})([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`),
                    end: new RegExp(`${t.open}/#(?:${c.join("|")})[\\r\\n\\t ]*>`)
                }
            },
            onEnterRules: [ {
                beforeText: new RegExp(`${t.open}#(?!(?:${u.join("|")}))([a-zA-Z_]+)([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`),
...
\r	 }]),.:;=`,
            ...
            folding: {
                markers: {
                    start: new RegExp(`[<\\[]#(?:${c.join("|")})([^/>\\]]*(?!/)[>\\]])[^<\\[]*$`),
                    end: new RegExp(`[<\\[]/#(?:${c.join("|")})[\\r\\n\\t ]*>`)
                }
            },
            onEnterRules: [ {
                beforeText: new RegExp(`[<\\[]#(?!(?:${u.join("|")}))([a-zA-Z_]+)([^/>\\]]*(?!/)[>\\]])[^[<\\[]]*$`),
    ...
    function i(t, n) {
        const _ = `_${t.id}_${n.id}`, e = l => l.replace(/__id__/g, _), o = l => {
            const S = l.source.replace(/__id__/g, _);
            return new RegExp(S, l.flags);
        };
        return {
            unicode: !0,
            includeLF: !1,
...
export {
    b as TagAngleInterpolationBracket,
    x as TagAngleInterpolationDollar,
    $ as TagAutoInterpolationBracket,
    D as TagAutoInterpolationDollar,
    E as TagBracketInterpolationBracket,
    B as TagBracketInterpolationDollar,
    R as __tla
};