...
let te, Ke = Promise.all([ (() => {
    ...
    t = d => (Ve("data-v-b4a67479"), d = d(), Le(), d), h = {
        class: "qusetion-info"
    }, b = {
        class: "info-item"
    }, _ = {
        ...
        setup(d, {
            ...
            return (v, r) => {
                const ve = Te, pe = Me, ye = Se, fe = He, ke = _e("show-tip");
                return i(), n("div", h, [ f(e("div", b, [ f(e("div", _, "题干", 512), [ [ ee, !a(Z) ] ]), e("div", {
                    class: "value",
                    innerHTML: a(l).stem
                ...
                }, null, 8, j) ]), e("div", A, [ x, e("div", B, [ (i(!0), n(se, null, le(a(l).answerKeywords, (s, y) => (i(), 
                we(ye, {
                    key: y + s.join(" 或 "),
                    class: "mr-2",
                    "disable-transitions": !1
                }, {
                    default: ie(() => [ f((i(), n("span", null, [ k(pe, {
                        content: s.join(" 或 "),
                        placement: "top",
                        "show-after": 300
                    }, {
                ...
                }, null, 8, P) ]), [ "2", "3", "4" ].includes(a(m)) ? (i(), n("div", R, [ z, e("div", D, c(a(l).remark ?? "--"), 1) ])) : o("", !0), a(l).markerRemarks.length > 0 ? (i(), 
                n("div", F, [ Q, e("div", U, c((p = a(l).markerRemarks, p.length > 0 ? p.map(s => `${s.marker ?? "--"}\uFF0C\u4E8E${ne(s.markerTime) ?? "--"}\u6279\u9605`).join("；") : "--")), 1) ])) : o("", !0) ], 2)), [ "3", "2", "4" ].includes(a(m)) && a(l).changeMarkers.length > 0 ? (i(), 
                n("div", $, [ (i(!0), n(se, null, le(a(l).changeMarkers, (s, y) => (i(), 
                n("div", {
                    key: y
