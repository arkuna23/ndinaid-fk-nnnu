...
let Ht, Fr = Promise.all([ (() => {
    ...
    let u, R, N, U, B, F, H, j, J, Q, E, K, Y, q, G, M, O, W, X, Z, $, tt, at, rt, et, st, lt, _t, ot, nt, ct, it, mt, ut, pt, yt, ft;
    u = b => (ha("data-v-8820d9ba"), b = b(), da(), b), R = {
        ...
        setup(b) {
            const w = la();
            S(() => w.params.id);
            const jt = l => "", Jt = S(() => _a().isSupAdmin), ht = e({}), C = e(!1), Qt = oa();
            e({}), e(null);
            const Et = e(null), dt = e(!1), Kt = e([]), vt = e([]), bt = e(null), k = e({}), d = e(!1), A = e({}), Ct = e(""), x = V({
                isAnswerAndAnalysisShow: !0,
                isScoreShow: !0
            }), Yt = S(() => w.params.classId), kt = S(() => w.params.teachCourseId);
            V({
                flag: []
            });
            const qt = e([ {
                ...
                La(r).then(_ => {
                    x.isAnswerAndAnalysisShow = _.isAnswerAndAnalysisShow || !1, 
                    x.isScoreShow = _.isScoreShow || !1, d.value = !0, Ct.value = "4", 
                    A.value = {
                        ..._,
                        ...r
                    };
            ...
            function Xt(l) {
                y.name = l.name || "", y.teachTags = l.teachTags || [], y.studyStatus = l.studyStatus || "", 
                y.sortType = l.sortType || 1, T();
            }
            const T = (l = !1) => {
                let r = {
                ...
                Pa(r).then(_ => {
                    Zt(), Tt.value = _.resList || [], Kt.value = [], l && _.resList && _.resList.length > 0 && (dt.value = !0), 
            ...
            return na(() => {
                ...
                const _ = ba, $t = ma, g = ua, St = pa, ta = ya, It = fa, aa = ea, wt = ca("show-tip");
                return o(), i("div", R, [ s(dt) ? (o(), i("div", N, [ a("div", U, [ c(_, {
                    ...
                    class: "left",
                    onHandleSearch: Xt
                }, null, 8, [ "searchList" ]), a("div", B, [ a("span", F, [ f("仅查看计入考核测验"), c($t, {
                    class: "ml5",
                    size: "small",
                    modelValue: s(y).isAssess,
                    "onUpdate:modelValue": r[0] || (r[0] = t => s(y).isAssess = t),
                    "active-value": 1,
                    "inactive-value": 0,
                    onChange: r[1] || (r[1] = t => T())
                }, null, 8, [ "modelValue" ]) ]), a("span", H, "已完成" + n(s(L)[0]) + "/" + n(s(L)[1]), 1) ]) ]), a("div", {
                    ref_key: "cardContainerRef",
                    ref: Et,
                    class: "card_container"
                }, [ (o(!0), i(Nt, null, Ut(s(Tt), (t, ra) => {
                    ...
                    I(St, {
                        ...
                        _: 1
                    })) : v("", !0) ]), a("div", Y, [ a("span", null, [ q, a("span", G, n(((At = t.resCtl) == null ? void 0 : At.multiTryTimes) ?? "0"), 1) ]), c(g, {
                        effect: "dark",
                        placement: "top",
                        enterable: !1,
                        disabled: t.status === 1
                    }, {
                        content: h(() => [ f("开始时间：" + n(t.resCtl.openTimeStr), 1), M, f("截止时间：" + n(t.resCtl.closeTimeStr || "无"), 1) ]),
                        default: h(() => {
                            var m;
                            return [ a("span", {
                                class: ia([ "stateLabel", {
                    ...
                    i("span", ot, [ a("span", nt, [ ct, a("span", it, n(s(Ft)(t.openTimeStr)), 1) ]), a("span", mt, [ ut, a("span", pt, n(s(Ft)(t.closeTimeStr)), 1) ]) ])) : v("", !0) ]), a("span", yt, [ t.studyStatus === 2 ? (o(), 
                    I(It, {
                        key: 0,
                        size: "small",
                        onClick: z(m => (p => {
                            ...
                            xa(P).then(Rt => {
                                Rt.length > 0 ? Ot(Rt[0]) : Qt.error("暂无提交记录");
                            });
                        })(t), [ "stop" ])
                    }, {
                        default: h(() => [ f("详情") ]),
