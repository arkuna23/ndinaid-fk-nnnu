...
let c, r, l, G = Promise.all([ (() => {
    ...
    const S = [ 9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288 ];
    function a(T) {
    ...
    o = new t((T, Q) => {
        if (T.next == 40) {
            let e = T.peek(-1);
            (a(e) || (n = e) >= 48 && n <= 57 || e == 95 || e == 45) && T.acceptToken(2, 1);
        }
        var n;
    }), i = new t(T => {
        if (S.indexOf(T.peek(-1)) > -1) {
            let {
                next: Q
            } = T;
            (a(Q) || Q == 95 || Q == 35 || Q == 46 || Q == 91 || Q == 58 || Q == 45) && T.acceptToken(110);
        }
    }), y = new t(T => {
        if (S.indexOf(T.peek(-1)) < 0) {
            let {
                next: Q
            } = T;
            if (Q == 37 && (T.advance(), T.acceptToken(1)), a(Q)) {
                do {
                    T.advance();
                } while (a(T.next));
                T.acceptToken(1);
    ...
    }), r = z(T => T.name == "VariableName" || T.name == "AtKeyword"), c = function() {
        return new w(l, l.data.of({
            autocomplete: r
        }));
    };
});
