...
let pe, We = Promise.all([ (() => {
    ...
    i = f => (je("data-v-ccf98ddb"), f = f(), De(), f), M = {
        class: "qusetion-info"
    }, T = {
        class: "info-item"
    }, A = {
        ...
        setup(f, {
            ...
            const he = fe, y = u(!1);
            u(!1);
            const ce = u({}), h = u(), _e = u(), _ = u(0), ke = () => {
                let n = t.value.candidateScore;
                n != _.value && he("computedScore", {
                    type: 2,
            ...
            function ue(n, s) {
                V.getSubmissions(n).then(c => {
                    if ([ "1", "2" ].includes(c.status_id)) setTimeout(() => {
                      ...
                      case 1:
                        h.value = atob(c.stdout), y.value = !0;
                        break;
            ...
            return Be(() => {
                ...
                }, null, 8, x) ], 512), [ [ S, !a(be) ] ]), e("div", B, [ C, e("div", H, [ m(Oe, {
                    dbInfo: a(ce),
                    showHideBtn: !0,
                    class: "info-box"
                ...
                }, "运行检查") ]) ]) ]), [ "0", "1", "2" ].includes(a(b)) ? (o(), d("div", D, [ e("div", F, [ me(" 得分 "), m(Ve, {
                ...
                }, null, 8, O) ]), [ "2", "3", "4" ].includes(a(b)) ? (o(), d("div", E, [ N, e("div", W, v(a(t).remark ?? "--"), 1) ])) : p("", !0), a(t).markerRemarks.length > 0 ? (o(), 
                d("div", X, [ Y, e("div", Z, v((w = a(t).markerRemarks, w.length > 0 ? w.map(l => `${l.marker ?? "--"}\uFF0C\u4E8E${ve(l.markerTime) ?? "--"}\u6279\u9605`).join("；") : "--")), 1) ])) : p("", !0) ], 2)), [ "3", "2", "4" ].includes(a(b)) && a(t).changeMarkers.length > 0 ? (o(), 
                d("div", ee, [ (o(!0), d(Le, null, Re(a(t).changeMarkers, (l, Me) => (o(), 
                d("div", {
                    key: Me
                }, [ e("div", ae, [ se, e("div", le, v(l.changeMarker ?? "--") + "，于" + v(a(ve)(l.changeMarkerTime) ?? "--") + "改阅", 1) ]), e("div", te, [ ie, e("div", ne, v(l.changeRevision ?? "--"), 1) ]) ]))), 128)) ])) : p("", !0), [ "0", "1" ].includes(a(b)) ? (o(), 
