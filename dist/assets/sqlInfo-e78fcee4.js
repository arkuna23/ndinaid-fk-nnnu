...
let _e, bl = Promise.all([ (() => {
    ...
    p = b => (al("data-v-78816cac"), b = b(), tl(), b), R = {
        class: "db-box"
    }, A = {
        class: "top-box"
    }, L = {
    ...
    }, " 请选择 .zip 文件，文件大小限制 1 Mb。 ", -1)), _e = cl({
        __name: "sqlInfo",
        props: {
            modelValue: {
                type: String,
        ...
        setup(b, {
            ...
            }), Ve = B(() => h.value.find(e => e.id === c.value) || {}), ae = B(() => h.value.find(e => e.id === w.value) || {}), T = u(), i = u({}), xe = u({
                dbName: [ {
                    required: !0,
                    message: "请输入数据库名称",
                    trigger: "blur"
            ...
            function Ce(e, l) {
                ge.$refs.dbFormRef.validate().then(() => {
                    if (I.value) m.updateDb({
                        ...
                        s.append("langId", g.value), m.createDb(s).then(() => {
                            V(), e && e();
                        }).catch(() => {
                            l && l();
                        });
            ...
            function De(e, l) {
                ae.value.valid ? (c.value = w.value, e && e()) : (message.warning("当前展示数据库的状态为停用，不可选中！"), 
                l && l());
            }
            function V() {
                m.getDbList(g.value).then(e => {
                    const {
                        data: l
                    } = e;
                    h.value = l;
            ...
            function ze(e) {
                e.type === "download" && m.downloadDb(e.row.id).then(l => {
            ...
            const Ue = () => {
                let e = btoa(_.value);
                E.value = !0, m.submissions(e, c.value).then(l => {
                    const {
                        data: s
                    } = l;
                    $.value = "", de(s);
            ...
            return Oe(() => {
                ...
                const s = Re, S = Ae, q = Le, x = je, se = Ge, P = Je, ue = Ye, qe = Ze, N = Ke, Fe = We, H = ml, Te = pl, $e = vl, Ee = Xe, ie = Qe("ComDialog"), Me = el, Pe = ll;
                return r(), f("div", R, [ n("div", A, [ a(se, {
                    ...
                    default: d(() => [ a(q, {
                        ...
                        default: d(() => [ a(S, {
                            ...
                            default: d(() => [ (r(!0), f(re, null, ce(o(il)(o(nl).QUESTION_SQL_TYPE), t => (r(), 
                            D(s, {
                                key: t.value,
                                label: t.label,
                                value: t.value
                        ...
                        default: d(() => [ a(S, {
                            ...
                            default: d(() => [ (r(!0), f(re, null, ce(o(h), t => (r(), 
                            D(s, {
                                key: t.id,
                                label: t.dbName,
                                value: t.id
                        ...
                        default: d(() => [ F(me(c.value ? "切换" : "选择") + "数据库", 1) ]),
                        _: 1
                    }) ]),
                    _: 1
                }) ]), c.value ? (r(), D(fe, {
                    ...
                    class: "info-box",
                    showHideBtn: !0
                }, null, 8, [ "dbInfo" ])) : z("", !0), c.value ? (r(), f("div", L, [ j, O((r(), 
                f("div", G, [ O(a(P, {
                    modelValue: o(_),
...
2.\u8FD0\u884C\u65F6\u5C06\u6267\u884C\u63A7\u5236\u53F0\u547D\u4EE4\u8BED\u53E5`,
                ...
                }, me(o(te)), 3), [ [ pe, o(v) === "输出" ] ]) ])), [ [ Pe, o(E) ] ]), n("div", J, [ a(qe, {
                    modelValue: o(v),
                            ...
                            default: d(t => [ a(Fe, {
                                onClick: Q(ne => function(k) {
                                    ...
                                    message.confirm('确认要"' + He + '"该项数据库吗?').then(() => {
                                        m.changeDbValid(k.id, !k.valid).then(() => {
