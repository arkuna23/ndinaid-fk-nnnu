...
let x, z = Promise.all([ (() => {
    ...
    let a, f, d, y, m, v, h;
    a = t => (C("data-v-4f6cb17b"), t = t(), L(), t), f = {
        style: {
            position: "relative"
        }
    }, d = {
        ...
        setup(t) {
            ...
            i("div", m, [ v, u("进行中学生：" + c(e.value.peopleNum[1].value) + "人", 1) ])) : _("", !0), o("div", null, [ h, u("未开始学生：" + c(e.value.peopleNum[e.value.peopleNum.length - 1].value) + "人", 1) ]) ])) : _("", !0) ]));
        }
    }, [ [ "__scopeId", "data-v-4f6cb17b" ] ]);
});
