...
let Z, d, o, A = Promise.all([ (() => {
    ...
    const i = [ 9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288 ], t = 10;
    function r(O) {
    ...
    function S(O) {
        let e;
        return O.next == 47 && ((e = O.peek(1)) == 47 || e == 42);
    }
    const x = new l((O, e) => {
        if (e.dialectEnabled(0)) {
            let Q;
            if (O.next < 0 && e.canShift(161)) O.acceptToken(161); else if (((Q = O.peek(-1)) == t || Q < 0) && e.canShift(160)) {
                let a = 0;
                for (;O.next != t && i.includes(O.next); ) O.advance(), a++;
                O.next == t || S(O) ? O.acceptToken(160, -a) : a && O.acceptToken(162);
            } else if (O.next == t) O.acceptToken(159, 1); else if (i.includes(O.next)) {
                for (O.advance(); O.next != t && i.includes(O.next); ) O.advance();
                O.acceptToken(162);
            }
        } else {
            let Q = 0;
            for (;i.includes(O.next); ) O.advance(), Q++;
            Q && O.acceptToken(162);
        }
    }, {
        contextual: !0
        ...
        if (S(O)) {
            if (O.advance(), e.dialectEnabled(0)) {
                let Q = -1;
                for (let a = 1; ;a++) {
                    let R = O.peek(-a - 1);
                    if (R == t || R < 0) {
                ...
                if (Q > -1) {
                    let a = O.next == 42, R = 0;
                    for (O.advance(); O.next >= 0; ) if (O.next == t) {
                        O.advance();
                        let n = 0;
                        for (;O.next != t && i.includes(O.next); ) n++, O.advance();
                        if (n < Q) {
                            R = -n - 1;
                            break;
                        }
                    } else {
                        if (a && O.next == 42 && O.peek(1) == 47) {
                            R = 2;
                            break;
                        }
                        O.advance();
                    }
                    return void O.acceptToken(a ? 7 : 6, R);
                }
            }
            if (O.next == 47) {
                for (;O.next != t && O.next >= 0; ) O.advance();
                O.acceptToken(6);
            } else {
        ...
        O.next != 43 && O.next != 61 || !e.dialectEnabled(0) || O.acceptToken(O.next == 61 ? 8 : 9, 1);
    }), h = new l((O, e) => {
        if (!e.dialectEnabled(0)) return;
        let Q = e.context.depth;
        if (O.next < 0 && Q) O.acceptToken(155); else if (O.peek(-1) == t) {
            let a = 0;
            for (;O.next != t && i.includes(O.next); ) O.advance(), a++;
            a == Q || O.next == t || S(O) || (a < Q ? O.acceptToken(155, -a) : O.acceptToken(154));
        }
    }), j = new l((O, e) => {
        for (let Q = !1, a = 0, R = 0; ;R++) {
            let {
                next: n
            } = O;
            if (!(r(n) || n == 45 || n == 95 || Q && c(n))) {
                if (n == 35 && O.peek(1) == 123) {
                    O.acceptToken(5, 2);
                    break;
                }
                Q && O.acceptToken(n == 40 ? 157 : a == 2 && e.canShift(4) ? 4 : 158);
                break;
            }
            !Q && (n != 45 || R > 0) && (Q = !0), a === R && n == 45 && a++, O.advance();
        }
    }), Y = new l(O => {
        if (O.next == 125) {
            for (O.advance(); r(O.next) || O.next == 45 || O.next == 95 || c(O.next); ) O.advance();
            O.next == 35 && O.peek(1) == 123 ? O.acceptToken(2, 2) : O.acceptToken(1);
        }
    }), q = new l(O => {
        if (i.includes(O.peek(-1))) {
            ...
            (r(e) || e == 95 || e == 35 || e == 46 || e == 91 || e == 58 || e == 45 || e == 38) && O.acceptToken(156);
        }
    }), T = new l(O => {
        if (!i.includes(O.peek(-1))) {
            let {
            ...
            if (e == 37 && (O.advance(), O.acceptToken(3)), r(e)) {
                do {
                    O.advance();
                } while (r(O.next));
                O.acceptToken(3);
    ...
    P = new z({
        start: new X(null, 0),
        shift: (O, e, Q, a) => e == 154 ? new X(O, Q.pos - a.pos) : e == 155 ? O.parent : O,
        hash: O => O.hash
    }), s = U({
        ...
        maxTerm: 180,
        context: P,
        nodeProps: [ [ "openedBy", 1, "InterpolationStart", 5, "InterpolationEnd", 21, "(", 75, "{" ], [ "isolate", -3, 6, 7, 26, "" ], [ "closedBy", 22, ")", 67, "}" ] ],
        propSources: [ s ],
        ...
        tokenizers: [ h, q, Y, T, j, x, W, v, 0, 1, 2, 3 ],
        topRules: {
            StyleSheet: [ 0, 10 ],
            Styles: [ 1, 134 ]
        },
        ...
        parser: k.configure({
            props: [ f.add({
                ...
                Comment: (O, e) => ({
                    from: O.from + 2,
                    to: e.sliceDoc(O.to - 2, O.to) == "*/" ? O.to - 2 : O.to
                })
            }), _.add({
                Declaration: b()
            }) ]
    ...
    }), d = N(O => O.name == "VariableName" || O.name == "SassVariableName"), Z = function(O) {
        return new w(O != null && O.indented ? u : o, o.data.of({
            autocomplete: d
        }));
    };
});
