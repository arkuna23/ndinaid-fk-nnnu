...
function t(i) {
    let a = [];
    const r = i.split(/\t+|\r+|\n+| +/);
    for (let e = 0; e < r.length; ++e) r[e].length > 0 && a.push(r[e]);
    return a;
}

var o = /[_\p{XID_Start}]\p{XID_Continue}*/u, n = "variable.predefined", c = {
    tokenPostfix: ".wgsl",
...
`),
    ...
    symbols: /[!%&*+\-\.\/:;<=>^|_~,]+/,
    tokenizer: {
        root: [ [ /enable|requires|diagnostic/, "keyword", "@directive" ], [ o, {
            cases: {
                "@atoms": n,
                "@keywords": "keyword",
                "@reserved": "invalid",
        ...
        directive: [ {
            include: "@commentOrSpace"
        }, [ /[()]/, "@brackets" ], [ /,/, "delimiter" ], [ o, "meta.content" ], [ /;/, "delimiter", "@pop" ] ],
