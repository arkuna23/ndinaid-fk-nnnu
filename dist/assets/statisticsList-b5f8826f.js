...
let q, ta = Promise.all([ (() => {
    ...
    let b, f, g, I, k;
    b = (u => (K("data-v-205cc94d"), u = u(), M(), u))(() => w("div", {
        style: {
            clear: "both"
        }
    }, null, -1)), f = {
                ...
                return s(), _("div", null, [ e(z, {
                    ...
                    default: h(() => [ e(C, {
                        ...
                        v(t, {
                            ...
                            default: h(o => [ o.row.status == 0 ? (s(), _("div", f, "未开始")) : o.row.status == 1 ? (s(), 
                            _("div", g, "进行中")) : (s(), _("div", I, "已完成")) ]),
                            _: 1
                        }), e(t, {
                            label: "最近学习时间",
                            prop: "updateTimeStr",
