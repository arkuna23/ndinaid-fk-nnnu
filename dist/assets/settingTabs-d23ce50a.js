...
let D, ce = Promise.all([ (() => {
    ...
    C = _ => (ee("data-v-c775db0f"), _ = _(), ae(), _), U = {
        style: {
            padding: "0px 40px"
        }
    }, L = C(() => t("div", {
    ...
    T = {
        ...
        setup(_, {
            ...
            const d = m(!1), r = m(!1), l = m([]), u = m([]), c = m([]), K = H, b = () => {
                ...
                se(() => {
                    x();
                    const n = document.querySelector("#tabs1List"), f = document.querySelector("#tabs2List");
                    z.create(n, {
                        group: "shared",
                        handle: ".handleIcon",
                        animation: 200,
            ...
            return G({
                ...
                return p(), X(o, {
                    ...
                    g(M, null, R(v(u), (e, V) => (p(), g("li", {
                        ...
                        onChange: x
                    }, null, 8, [ "modelValue", "onUpdate:modelValue" ]), t("span", E, I(V + 1) + ".", 1), i(I(e.columTypeName), 1), S ]))), 128)) ]), t("ul", N, [ (p(!0), 
                    g(M, null, R(v(c), (e, V) => (p(), g("li", {
                        class: "tabsItem",
                        key: e.sort
                    }, [ h(n, {
                        modelValue: e.isChoose,
                        "onUpdate:modelValue": k => e.isChoose = k,
                        onChange: x
                    }, null, 8, [ "modelValue", "onUpdate:modelValue" ]), t("span", B, I(v(u).length + V + 1) + ".", 1), i(I(e.columTypeName), 1), q ]))), 128)) ]) ]), t("div", F, [ h(f, {
