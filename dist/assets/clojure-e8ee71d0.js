...
function i(t, e) {
    ...
    return n ? n === "comment" && e.lastToken === "(" ? (e.tokenize = x)(t, e) : a(n, p) || n.charAt(0) === ":" ? [ "symbol", "atom" ] : a(n, m) || a(n, f) ? [ "symbol", "keyword" ] : e.lastToken === "(" ? [ "symbol", "builtin" ] : [ "symbol", "variable" ] : (t.next(), 
    t.eatWhile(function(s) {
        return !a(s, y);
    }), [ null, "error" ]);
}
...
function x(t, e) {
    for (var r, n = 1; r = t.next(); ) if (r === ")" && n--, r === "(" && n++, n === 0) {
...
function a(t, e) {
    return e instanceof RegExp ? e.test(t) : e instanceof Object ? e.propertyIsEnumerable(t) : void 0;
}
...
const w = {
    ...
    token: function(t, e) {
        ...
        return n !== "space" && (e.lastToken === "(" && e.ctx.indentTo === null ? n === "symbol" && a(c, h) ? e.ctx.indentTo = e.ctx.start + t.indentUnit : e.ctx.indentTo = "next" : e.ctx.indentTo === "next" && (e.ctx.indentTo = t.column()), 
        e.lastToken = c), n === "open" ? e.ctx = {
            prev: e.ctx,
            start: t.column(),
            indentTo: null
        } : n === "close" && (e.ctx = e.ctx.prev || e.ctx), s;
    },
    indent: function(t) {
