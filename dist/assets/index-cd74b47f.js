...
let e, s, l, y, i, m, r = Promise.all([ (() => {
    ...
    e = async t => await a.get({
        ...
        params: t
    }), y = async t => await a.get({
        url: "/system/notify-template/get?id=" + t
    }), s = async t => await a.post({
        url: "/system/notify-template/create",
        data: t
    }), m = async t => await a.put({
        url: "/system/notify-template/update",
        data: t
    }), l = async t => await a.delete({
        url: "/system/notify-template/delete?id=" + t
    }), i = t => a.post({
